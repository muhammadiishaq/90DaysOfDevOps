...
```
![snapshot](https://github.com/muhammadiishaq/90DaysOfDevOps/blob/master/2026/day-14/Task-images/curl.png)
...
![snapshot](https://github.com/muhammadiishaq/90DaysOfDevOps/blob/master/2026/day-14/Task-images/hostname.png)
...
ping <target>
```
![snapshot](https://github.com/muhammadiishaq/90DaysOfDevOps/blob/master/2026/day-14/Task-images/ping.png)
...
nslookup <domain>
```
![snapshot](https://github.com/muhammadiishaq/90DaysOfDevOps/blob/master/2026/day-14/Task-images/dig.png)
...
ss -tulpn
```
![snapshot](https://github.com/muhammadiishaq/90DaysOfDevOps/blob/master/2026/day-14/Task-images/ss.png)
...
```
![snapshot](https://github.com/muhammadiishaq/90DaysOfDevOps/blob/master/2026/day-14/Task-images/ssh.png)
